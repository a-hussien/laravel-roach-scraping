...
<html lang="en" dir="ltr">
    <head>
        ...
        <title>Books | Roach Web Scraping with laravel</title>
        @vite(['resources/css/app.css', 'resources/js/app.js'])
    </head>
    <body>
        <div class="min-h-screen bg-slate-100">
            <div class="p-4">
                <h2 class="text-4xl font-figtree font-medium text-slate-900 text-center mx-auto mb-8">Books</h2>
                <div class="flex flex-col md:flex-row flex-wrap gap-8 justify-center items-center mx-auto">
                    @foreach ($items[0]['books'] as $i => $item)
